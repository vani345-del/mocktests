...
export default function CategoryPage() {
    ...
    const getMocktests = async () => {
        setLoading(true);
        try {
            // API call to fetch tests specific to the category slug
    ...
    const handleDelete = async (id) => {
        // NOTE: Standard browser 'confirm()' is disabled in this environment.
        // You MUST implement a custom modal UI for confirmation here.
        // For now, we will assume confirmation logic is handled externally, or
        // we skip confirmation entirely for quick testing (NOT recommended for production).
        
        // Example of a proper placeholder:
        // if (!await showCustomConfirmationModal("Are you sure you want to delete this mocktest?")) return;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-100 via-white to-slate-200 px-6 py-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-10">
                ...
                {/* Create Button (links to the actual creation page with category pre-selected) */}
                <Link
